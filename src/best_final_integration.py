...
integration_model = torch.load("params/integration_hope_best.params")

unbalance = torch.FloatTensor([1.0, 7.8])
# use Adam optimizer
optimizer = optim.Adam(integration_model.parameters(), lr=1e-4)
    ...
    for i, data in enumerate(train_loader, 0):
		...
		if i % 200 == 199:    # print every 200 mini-batches
			...
			if cur_val_auc > last_val_auc:
				...
				torch.save(integration_model, "params/integration_hope_best_up.params")
			# itchat.send(
